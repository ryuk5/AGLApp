...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Create a Demand</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('applicant.demands.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dl" type="text" class="form-control" name="dl" required >    
                            </div>
                        </div>
