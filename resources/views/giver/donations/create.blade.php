...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Create a Donation</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('giver.donations.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="availability" type="text" class="form-control" name="availability" required >    
                            </div>
                        </div>
